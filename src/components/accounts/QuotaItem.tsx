...
export function QuotaItem({ label, percentage, resetTime, isProtected, className, Icon }: QuotaItemProps) {
    ...
    return (
        <div className={cn(
            "relative h-[18px] flex items-center px-1 rounded-sm overflow-hidden border border-gray-100/50 dark:border-white/5 bg-gray-50/30 dark:bg-white/5 group/quota",
            className
        )}>
            ...
            {/* Content */}
            <div className="relative z-10 w-full flex items-center text-[9px] font-mono leading-none gap-1">
                {/* Model Name */}
