...
function Accounts() {
  ...
  }, [localPageSize, 10, containerSize, viewMode]);
      ...
      <div className="flex-none flex items-center gap-2">
        ...
        <div className="hidden lg:block flex-none w-40 relative transition-all focus-within:w-48">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 bg-white dark:bg-base-100 text-xs text-gray-900 dark:text-base-content border border-gray-200 dark:border-base-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder:text-gray-400 dark:placeholder:text-gray-500"
            value={searchQuery}
        ...
        <div className="flex gap-0.5 bg-gray-100/80 dark:bg-base-200 p-0.5 rounded-lg border border-gray-200/50 dark:border-white/5 shrink-0">
          ...
          <button
            className={cn(
              "flex px-2 py-1 rounded-md text-[10px] font-semibold transition-all items-center gap-1 whitespace-nowrap shrink-0",
              filter === 'ultra'
                ? "bg-white dark:bg-base-100 text-blue-600 dark:text-blue-400 shadow-sm ring-1 ring-black/5"
                : "text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-base-content hover:bg-white/40"
            )}
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {selectedIds.size > 0 && (
            <>
              <button
                className="px-2 py-1 bg-red-500 text-white text-[10px] font-medium rounded-md hover:bg-red-600 transition-colors flex items-center gap-1.5 shadow-sm"
          ...
          <button
            className={`px-1.5 py-1 bg-blue-500 text-white text-[10px] font-medium rounded-md hover:bg-blue-600 transition-colors flex items-center gap-1.5 shadow-sm ${isRefreshing ? "opacity-70 cursor-not-allowed" : ""}`}
          ...
          <label className="flex items-center gap-1.5 cursor-pointer select-none px-2 py-1 border border-transparent hover:bg-gray-100 dark:hover:bg-base-200 rounded-md transition-colors" title={t('accounts.show_all_quotas')}>
            <span className="text-[10px] font-medium text-gray-600 dark:text-gray-300 hidden xl:inline">
              {t('accounts.show_all_quotas')}
            </span>
            <input
              type="checkbox"
              className="checkbox checkbox-xs rounded border-gray-300 dark:border-gray-600 checked:border-blue-600 checked:bg-blue-600 [--chkbg:theme(colors.blue.600)] [--chkfg:white]"
