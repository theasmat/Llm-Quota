...
function Dashboard() {
    ...
    return (
        <div className="h-full w-full overflow-y-auto">
            <div
                className="p-3 space-y-2 max-w-7xl mx-auto"
            ...
            >
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                    <div className="bg-white dark:bg-base-100 rounded-lg p-2 shadow-sm border border-gray-100 dark:border-base-200">
                        ...
                        <div className="text-lg font-bold text-gray-900 dark:text-base-content mb-0.5">{stats.total}</div>
                        <div className="text-[10px] text-gray-500 dark:text-gray-400">{t('dashboard.total_accounts')}</div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-base-100 rounded-lg p-2 shadow-sm border border-gray-100 dark:border-base-200">
                        ...
                        <div className="text-lg font-bold text-gray-900 dark:text-base-content mb-0.5">{stats.avgGemini}%</div>
                        <div className="text-[10px] text-gray-500 dark:text-gray-400">{t('dashboard.avg_gemini')}</div>
                        {stats.avgGemini > 0 && (
                    ...
                    <div className="bg-white dark:bg-base-100 rounded-lg p-2 shadow-sm border border-gray-100 dark:border-base-200">
                        ...
                        <div className="text-lg font-bold text-gray-900 dark:text-base-content mb-0.5">{stats.avgGeminiImage}%</div>
                        <div className="text-[10px] text-gray-500 dark:text-gray-400">{t('dashboard.avg_gemini_image')}</div>
                    ...
                    <div className="bg-white dark:bg-base-100 rounded-lg p-2 shadow-sm border border-gray-100 dark:border-base-200">
                        <div className="flex items-center justify-between mb-2">
                            <div className="p-1 bg-cyan-50 dark:bg-cyan-900/20 rounded-md">
                                <Bot className="w-3 h-3 text-cyan-500 dark:text-cyan-400" />
                            </div>
                        </div>
                        <div className="text-lg font-bold text-gray-900 dark:text-base-content mb-0.5">{stats.avgClaude}%</div>
                        <div className="text-[10px] text-gray-500 dark:text-gray-400">{t('dashboard.avg_claude')}</div>
                        {stats.avgClaude > 0 && (
                    ...
                    <div className="bg-white dark:bg-base-100 rounded-lg p-2 shadow-sm border border-gray-100 dark:border-base-200">
                        ...
                        <div className="text-lg font-bold text-gray-900 dark:text-base-content mb-0.5">{stats.lowQuota}</div>
                        <div className="text-[10px] text-gray-500 dark:text-gray-400">{t('dashboard.low_quota_accounts')}</div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                        <span className="text-indigo-700 dark:text-indigo-300 font-medium text-xs">{t('dashboard.view_all_accounts')}</span>
                        <ArrowRight className="w-3.5 h-3.5 text-indigo-400 dark:text-indigo-500 group-hover:text-indigo-600 dark:group-hover:text-indigo-300 group-hover:translate-x-1 transition-all" />
                    </button>
                    <button
                        className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-2 shadow-sm border border-purple-100 dark:border-purple-900/30 hover:border-purple-300 dark:hover:border-purple-700 hover:shadow-md transition-all flex items-center justify-between group"
                        onClick={handleExport}
                    >
                        <span className="text-purple-700 dark:text-purple-300 font-medium text-xs">{t('dashboard.export_data')}</span>
                        <Download className="w-3.5 h-3.5 text-purple-400 dark:text-purple-500 group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-all" />
                    </button>
                </div>
            </div>
        </div>
